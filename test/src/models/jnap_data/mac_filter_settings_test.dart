...
void main() {
  group('MACFilterSettingsData', () {
    const macFilterSettings = MACFilterSettingsData(
      macFilterMode: 'Allow',
      maxMACAddresses: 10,
    ...
    test('fromMap creates a valid object', () {
      expect(MACFilterSettingsData.fromMap(macFilterSettingsMap), macFilterSettings);
    });
    ...
    test('fromJson creates a valid object from JSON string', () {
      expect(MACFilterSettingsData.fromJson(json.encode(macFilterSettingsMap)), macFilterSettings);
    });
    ...
    test('props are correct', () {
      final settings1 = MACFilterSettingsData(macFilterMode: 'm1', maxMACAddresses: 1, macAddresses: ['a1']);
      final settings2 = MACFilterSettingsData(macFilterMode: 'm1', maxMACAddresses: 1, macAddresses: ['a1']);
      final settings3 = MACFilterSettingsData(macFilterMode: 'm2', maxMACAddresses: 2, macAddresses: ['a2']);
