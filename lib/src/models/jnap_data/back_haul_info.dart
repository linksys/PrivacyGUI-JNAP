...
class WirelessConnectionInfo extends Jsonable {
  ...
  factory WirelessConnectionInfo.fromJson(String source) =>
      WirelessConnectionInfo.fromMap(jsonDecode(source));
...
class BackHaulInfoData extends Jsonable {
  ...
  factory BackHaulInfoData.fromJson(String source) =>
      BackHaulInfoData.fromMap(jsonDecode(source));
}
