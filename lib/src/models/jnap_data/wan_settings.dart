...
class StaticSettings extends Jsonable {
  ...
  factory StaticSettings.fromJson(String source) =>
      StaticSettings.fromMap(jsonDecode(source));
...
class PPPoESettings extends Jsonable {
  ...
  factory PPPoESettings.fromJson(String source) =>
      PPPoESettings.fromMap(jsonDecode(source));
...
class TPSettings extends Jsonable {
  ...
  factory TPSettings.fromJson(String source) =>
      TPSettings.fromMap(jsonDecode(source));
...
class TelstraSettings extends Jsonable {
  final String server;
  final String username;
  final String password;
  ...
  factory TelstraSettings.fromJson(String source) =>
      TelstraSettings.fromMap(jsonDecode(source));

  @override
  List<Object> get props => [server, username, password];
}

class BridgeSettings extends Jsonable {
  final bool useStaticSettings;
  final StaticSettings? staticSettings;
  ...
  factory BridgeSettings.fromJson(String source) =>
      BridgeSettings.fromMap(jsonDecode(source));

  @override
  List<Object?> get props => [useStaticSettings, staticSettings];
}

class DSLiteSettings extends Jsonable {
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'manualSettings': manualSettings?.toMap(),
    }..removeWhere((key, value) => value == null);
  }
  ...
  factory DSLiteSettings.fromJson(String source) =>
      DSLiteSettings.fromMap(jsonDecode(source));

  @override
  List<Object?> get props => [useManualSettings, manualSettings];
}

class WirelessModeSettings extends Jsonable {
  final String ssid;
  final String? bssid;
  final String? band;
  ...
  factory WirelessModeSettings.fromJson(String source) =>
      WirelessModeSettings.fromMap(jsonDecode(source));

  @override
  List<Object?> get props => [ssid, bssid, band, security, password];
}

class AFTRSettings extends Jsonable {
  ...
  factory AFTRSettings.fromJson(String source) =>
      AFTRSettings.fromMap(jsonDecode(source));

  @override
  List<Object?> get props => [aftrURL, afterAddress];
}

class SinglePortVLANTaggingSettings extends Jsonable {
  ...
  factory SinglePortVLANTaggingSettings.fromJson(String source) =>
      SinglePortVLANTaggingSettings.fromMap(jsonDecode(source));
...
class PortTaggingSettings extends Jsonable {
  final int vlanID;
  ...
  factory PortTaggingSettings.fromJson(String source) =>
      PortTaggingSettings.fromMap(jsonDecode(source));
