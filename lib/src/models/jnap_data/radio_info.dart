...
class RouterRadio extends Jsonable {
  ...
  factory RouterRadio.fromJson(String source) =>
      RouterRadio.fromMap(jsonDecode(source));
}

class RouterRadioSettings extends Jsonable {
  ...
  factory RouterRadioSettings.fromJson(String source) =>
      RouterRadioSettings.fromMap(jsonDecode(source));
}

class WepSettings extends Jsonable {
  ...
  factory WepSettings.fromJson(String source) =>
      WepSettings.fromMap(jsonDecode(source));
}

class WpaPersonalSettings extends Jsonable {
  ...
  factory WpaPersonalSettings.fromJson(String source) =>
      WpaPersonalSettings.fromMap(jsonDecode(source));
}

class WpaEnterpriseSettings extends Jsonable {
  ...
  factory WpaEnterpriseSettings.fromJson(String source) =>
      WpaEnterpriseSettings.fromMap(jsonDecode(source));
}

class SupportedChannelsForChannelWidths extends Jsonable {
  final String channelWidth;
  ...
  factory SupportedChannelsForChannelWidths.fromJson(String source) =>
      SupportedChannelsForChannelWidths.fromMap(jsonDecode(source));
}
